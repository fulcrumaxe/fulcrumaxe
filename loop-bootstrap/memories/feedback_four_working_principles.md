...
tier: transferable
---
Every agent doing project work (executor, code-reviewer, impl-coordinator, PM) must apply these four principles. They directly map to recurring bug categories observed in the codebase.
